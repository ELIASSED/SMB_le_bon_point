    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Nous sommes ravis de vous confirmer votre inscription pour le stage suivant :</p>
          ...
          <p>Veuillez conserver cet e-mail comme preuve de votre inscription et apporter les documents nécessaires le jour du stage.</p>
          <a href="https://votre-site.com/mon-compte" class="btn">Accéder à mon espace</a>
          <p>En cas de besoin, n’hésitez pas à nous contacter ${
            contactEmail ? `par email : <a href="mailto:${contactEmail}">${contactEmail}</a>` : ""
          }${contactPhone ? ` ou par téléphone : <strong>${contactPhone}</strong>` : ""}.</p>
