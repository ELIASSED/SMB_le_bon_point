...
import { Stage } from "./types"; // Assurez-vous que ce fichier existe

// Interface pour les props du composant StageList
interface StageListProps {
  stages: Stage[]; // Typé comme un tableau de Stage
  loading: boolean; // Indique si les données sont en cours de chargement
  currentPage: number; // Page actuelle
  totalPages: number; // Nombre total de pages
  onStageSelected: (stage: Stage) => void; // Callback pour sélectionner un stage
  handlePrevPage: () => void; // Callback pour la page précédente
  handleNextPage: () => void; // Callback pour la page suivante
  handleDataUpdate: () => void; // Callback pour mettre à jour les données après tri
}
