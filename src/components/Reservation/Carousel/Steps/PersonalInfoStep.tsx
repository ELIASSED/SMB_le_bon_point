// components/Carousel/PersonalInfoStep.tsx
"use client";
import React from "react";
import { Stage, PersonalInfo } from "../types";
import { formatDateWithDay } from "../utils";
import PersonalInfoForm from "../Form/PersonalInfoForm"; // Chemin d'import à ajuster selon votre structure
...
const PersonalInfoStep: React.FC<PersonalInfoStepProps> = ({ selectedStage, onSubmit }) => {
  ...
  return (
    <>
      ...
      <PersonalInfoForm onNext={onSubmit} />
    </>
  );
};
